...
from humanoid_tennis.envs.mdp.commands.utils import add_spherical_noise, rand_points_disk


if TYPE_CHECKING:
    from mjlab.entity import Entity as Articulation
    from humanoid_tennis.envs.base import _Env
    from humanoid_tennis.envs.mdp.commands.motion_tracking import MotionTrackingCommand
